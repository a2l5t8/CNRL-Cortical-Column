...
class L4() : 
    ...
    def __init__(self, net, HEIGHT, WIDTH, IN_CHANNEL, OUT_CHANNEL, INH_SIZE) : 
        ...
        self.config = {
            ...
            "J0" : 300,
            "p" : 0.8,
            "inh_shape" : (1, 1, OUT_CHANNEL * 2 + 1, INH_SIZE, INH_SIZE)
        }
    ...
    def _add_sg(self) :
        ...
        # inh_lateral_weight[0][0][self.config["inh_shape"][2] // 2][self.config["inh_shape"][3] // 2][self.config["inh_shape"][4] // 2]
        ...
        #         SynapseInit(),
        #         WeightInitializer(weights=inh_lateral_weight.to(self.net.device)),
        #         SimpleDendriticInput(current_coef=-10),
        #     ]) | ({
